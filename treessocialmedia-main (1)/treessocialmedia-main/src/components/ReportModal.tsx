      ...
      <DialogContent className="sm:max-w-md max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-blue-800">
                Reporting {getTypeLabel().toLowerCase()}
              </span>
            </div>
            <p className="text-sm text-blue-700 mt-1">
              Your report will be reviewed by our moderation team. Please
              provide accurate information to help us take appropriate action.
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
            <p className="text-xs text-muted-foreground">
              <strong>Privacy Notice:</strong> Your report will be handled
              confidentially. We may contact you for additional information if
              needed. False reports may result in account restrictions.
            </p>
          </div>
        </div>
