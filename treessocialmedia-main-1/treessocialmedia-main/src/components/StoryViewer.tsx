...
export const StoryViewer: React.FC<StoryViewerProps> = ({
  ...
  const handleDeleteStory = async () => {
    try {
      ...
      // Remove deleted story from current stories list
      const updatedStories = stories.filter(
        (story) => story.id !== currentStory.id,
      );

      // If there are still stories left
      ...
      // Notify parent to refresh story list
                    ...
                    isOwner && (
                      <>
                        ...
                        <Button
                          ...
                          className="text-red-500 hover:bg-red-500/20 p-2"
